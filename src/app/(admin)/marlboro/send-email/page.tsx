  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
      <div style={{ marginBottom: '2.5rem' }}>
        <h1 style={{ fontSize: '2.2rem', fontWeight: 800, color: '#111', margin: 0, display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <Mail size={32} /> E-posta Gönder
        </h1>
        <p style={{ color: '#666', marginTop: '0.5rem' }}>Müşterilerinize veya herhangi bir adrese profesyonel e-posta gönderin.</p>
      </div>

      <div style={{ backgroundColor: 'white', padding: '2.5rem', borderRadius: '28px', boxShadow: '0 10px 40px rgba(0,0,0,0.03)', border: '1px solid #f0f0f0' }}>
